...
def parse_dataset_config() -> argparse.ArgumentParser:
    ...
    data_transformations.add_argument('--num_transformers', type=int, default=2, help='Number of random transformations to apply')
    ...
    data_transformations.add_argument('--fill_value', type=int, default=65, help='Value with which to fill the blank pixels after transformations')
