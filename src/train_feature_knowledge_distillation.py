...
def create_fb_kd_trainer(student_model: nn.Module,
                      ...
                      ) -> FeatureBasedKnowledgeDistillationTrainer:
    return FeatureBasedKnowledgeDistillationTrainer(
        student_model=student_model,
        teacher_model=teacher_model,
        response_distillation_loss=response_distillation_loss,
...
if __name__ == '__main__':
    # Config
    train_config = parse_fb_kd_train_config()
    evaluation_config = parse_fb_kd_train_config()
    ...
    trainer = create_fb_kd_trainer(student_model,
                                   teacher_model,
                                   response_loss,
                                   feature_loss,
                                   train_config.response_loss_weight,
                                   train_config.feature_loss_weight,
                                   training_args,
                                   train_dataset,
                                   eval_dataset,
