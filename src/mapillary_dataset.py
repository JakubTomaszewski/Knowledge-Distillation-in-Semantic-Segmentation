...
class MapillaryDataset(Dataset):
    ...
    def __getitem__(self, index) -> Tuple:
        # access samplex by index: dataset[i]
        # loads sample and label
        ...
        self.load_image(self.data_path / sample_filename)
        self.load_image(self.labels_path / label_filename)
        
        return sample_filename, label_filename
